...
%\tcbset{colback=white,colframe=black!15,fonttitle=\bfseries, coltitle=black}
\tcbuselibrary{theorems}
\tcbuselibrary{skins}


\usepackage{minted} %compile： lualatex/xelatex -shell-escape spark.tex
\usemintedstyle{bw} % https://pygments.org/styles/ % stata-light
...
\usepackage{seqsplit}
\usepackage{path}
\newcommand{\inlinecmd}[1]{{\texttt{#1}}}
\newcommand{\inlinefile}[1]{\seqsplit{\texttt{#1}}}
\newcommand{\inlinepython}[1]{\seqsplit{\texttt{#1}}}
%\newcommand{\variable}[1]{ \colorbox{yellow!10}{#1} }
\newcommand{\variable}[1]{{\texttt{#1}}}
\newcommand{\inlineurl}[1]{{\texttt{#1}}}
