...
\usemintedstyle{stata-light} % https://pygments.org/styles/
\setminted{encoding=utf-8} %注意字体，如果设置了CJKmonofont，会出现乱码
\setminted{linenos=true,
		frame=none, % 单线边框:single
    	framesep=2mm,
    	baselinestretch=1.2,
		tabsize=4, 
		xleftmargin=1mm,
...
\setminted{numbersep=2mm}
\setminted{fontsize=\small}
%\setminted{fontfamily="Ubuntu Mono", fontsize=\small}
...
%自定义的一些命令，方便使用
\newcommand*\circled[1]{\vspace{3pt}\tikz[baseline=(char.base)]{
  \node[shape=circle,draw,inner sep=1pt] (char) {#1};}}

% 利用pifont在heading前加上方框符号
\newcommand{\heading}[1]{  {\vspace{5pt} \color{darkgray}\noindent ~~ \ding{111} \textbf{#1}} \vspace{3pt}}

\newcommand{\inlinecmd}[1]{ \colorbox{blue!5}{#1} }
\newcommand{\inlinefile}[1]{ \colorbox{orange!10}{#1} }
\newcommand{\inlinepython}[1]{ \colorbox{red!3}{#1} }
\newcommand{\variable}[1]{ \colorbox{yellow!10}{#1} }
\newcommand{\inlinecode}[2]{\mintinline{#1}[fontsize=\normalsize]{#2}}

\newcommand{\textem}[1]{{\color{red} #1}} % 强调文本
...
\setmonofont{Intel One Mono} % 代码字体
